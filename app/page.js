...
const Dashboard = () => {
  ...
  const [tabsValue, setTabsValue] = useState('calculator');
  ...
  return (
    <div className="min-h-screen bg-orange-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-xl p-6">
        ...
        <Tabs defaultValue="calculator" className="w-full" value={tabsValue} onValueChange={setTabsValue}>
          ...
          <TransitionGroup>
            <CSSTransition key={tabsValue} timeout={500} classNames="fade">
              {tabsValue === 'calculator' && (
